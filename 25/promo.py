...
class Promo:
    ...
    def _bites_available(self):
        return [avail for avail in list(BITES.keys()) if avail not in self.bites_done]

    def _pick_random_bite(self):
        try:
            return random.choice(self._bites_available())
        except IndexError:
